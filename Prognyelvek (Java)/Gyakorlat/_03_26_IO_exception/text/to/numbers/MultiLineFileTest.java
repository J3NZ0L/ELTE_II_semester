...
public class MultiLineFileTest{
    ...
    public void fileNotExist(){
        ...
        try {
            ...
            //MultiLineFile.addNumbers("_03_26_IO_exception/text/to/numbers/wrong.txt");
            MultiLineFile.addNumbers("_03_26_IO_exception/source.txt"," ");
    ...
    @Test
    public void validFileTestWithSpace(){
        try{
            MultiLineFile.addNumbers("_03_26_IO_exception/validfile.txt"," ");
        }   catch(IOException e){
    ...
    @Test
    public void validFileTestWithComma(){
        try{
            MultiLineFile.addNumbers("_03_26_IO_exception/validfile.txt",",");
        }   catch(IOException e){
            fail("Found valid file test: FAILED!");
